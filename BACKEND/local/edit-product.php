...
<body class="bg02">
                ...
                <div class="bg-white tm-block">
                    ...
                    <div class="row mt-4 tm-edit-product-row">
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <form action="gastronomia.php" class="tm-edit-product-form" id="formEditar" method="POST">
                                <?php
                                ...
                                <div class="input-group mb-3">
                                    <div class="ml-auto col-xl-8 col-lg-8 col-md-8 col-sm-7 pl-0">
                                        <button type="button" class="btn btn-primary" id="editarMenu">Editar
                                        </button>
                                    </div>
                                </div>
                            </form>
    ...
    <script src="js/codigoModificar.js"></script>
    <script>
        $(".alert-success").hide();
        $(".alert-danger").hide();
    </script>
