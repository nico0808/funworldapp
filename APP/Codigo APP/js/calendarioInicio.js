...
function llamarCalendario(tipoEvento, edad, checkFantasy, checkMagic, clickeable) {
  ...
  salonMagic = [];
  $.ajax({
    url: "http://grupotransamerican.com.uy/funworld/proyecto/eventoCalendario.php",
    type: "GET",
    dataType: "json",
    success: enviado,
    error: error
  ...
  function calendarioClick(info) {
    ...
    $.ajax({
      url: "http://grupotransamerican.com.uy/funworld/proyecto/eventoCalendario.php?fechaEvento=" + info.dateStr + "&salon=" + salon,
      type: "GET",
      dataType: "json",
      success: enviadoDia,
      error: error
